 ...
 return knex.raw("truncate table items cascade")
   .then(function () {
     return Promise.all([
       ...
       knex('items').insert({id: 8, name: 'Calamari Fritti', price: '12', restaurants_id:'1', img_url:'http://www.theforkbite.com/wp-content/uploads/2015/09/calamari-2-1.jpg', details:'served with wine, garlic & fresh herbs - served with focaccia'}),
