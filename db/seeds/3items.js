 ...
 return knex.raw("truncate table items cascade")
   .then(function () {
     return Promise.all([
       ...
       knex('items').insert({id: 8, name: 'Calamari Fritti', price: '12', restaurants_id:'1', img_url:'http://www.theforkbite.com/wp-content/uploads/2015/09/calamari-2-1.jpg', details:'Dear diary, chapter 5, day 31. Been coding for what seems like years now. Cant remember the last time I slept. Still have more work to do. Recieved lashings from David again for poor syntax and indentation. Pretty sure I witnessed Don waterboard a student for being late, must be careful not to anger him.  I dont think im going to make it out alive. If anyone reads this, tell my family I miss them.'}),
